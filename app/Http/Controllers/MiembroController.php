...
class MiembroController extends Controller
{
    ...
    public function store(Request $request){
        ...
        return redirect()->route('miembros.index')->with('mensaje','Se registró al trabajador de la manera correcta');
    ...
    public function update(Request $request, $id){
        ...
        return redirect()->route('miembros.index')->with('mensaje','Se actualizó al trabajador de la manera correcta');
    ...
    public function destroy($id){
        ...
        Storage::delete('public/'.$miembro->fotografia);
        Miembro::destroy($id);
        return redirect()->route('miembros.index')->with('mensaje','Se eliminó al trabajador de la manera correcta');
    }
}
