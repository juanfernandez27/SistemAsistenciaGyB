...
class MinisterioController extends Controller
{
    ...
    public function store(Request $request)
    {
       ...
       // return response()->json($ministerio);
        ...
        return redirect()->route('ministerios.index')->with('mensaje','Se registró el área de la manera correcta');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('ministerios.index')->with('mensaje','Se actualizó el área de la manera correcta');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('ministerios.index')->with('mensaje','Se eliminó el área de la manera correcta');
    }
}
